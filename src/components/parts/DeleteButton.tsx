...
const DeleteButton: React.FC<Props> = ({ posting_id }) => {
  ...
  return (
    <>
      <button
        className="m-1 block w-24 text-white bg-red-600 hover:bg-red-700 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800"
        onClick={openPopup}
        type="button"
      >
        Delete
